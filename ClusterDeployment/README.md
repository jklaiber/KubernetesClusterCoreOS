...
## Content
* [Getting started](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#getting-started)
* [Create Deployment Script](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#create-deployment-script)
* [Master Deployment](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#master-deployment)
  * [Minimum Requirements](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#minimum-requirements)
  * [Initialize Master](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#initialize-master)
  * [Access to the Cluster](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#access-to-the-cluster)
  * [Flannel Plugin](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#flannel-plugin)
* [Worker Deployment](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#worker-deployment)
  * [Minimum Requirements](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#minimum-requirements-1)
  * [Initialize Worker](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#initialize-workers)
  * [Join Cluster](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#join-cluster)
* [Loadbalancing Deployment](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#loadbalancing-deployment)
  * [DigitalOcean Load Balancer](link)
  * [ToDo Bare Metal Load Balancer](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#todo-loadbalancing)
* [Dashboard Deployment](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#dashboard-deployment)
  * [Create Dashboard Admin ClusterRole](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#create-dashboard-admin-clusterrole)
  * [Access the dashboard](https://github.com/jklaiber/KubernetesClusterCoreOS/blob/master/README.md#access-the-dashboard)
